...
export default function RecuperarPalavraPasse() {
    return (
        <>
            <Head>
                <title>Recuperar Palavra-passe - Kuenda Delivery</title>
                            ...
                            <div className="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                                <div className="w-full">
                                    ...
                                    <div className="block text-sm">
                                        <span className="text-gray-700 dark:text-gray-400">Telefone associado a sua conta</span>
                                        <input
                                            className="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input"
                                            placeholder="ex: 9XX123456"
                                        />
                                    </div>
                                    <div>
