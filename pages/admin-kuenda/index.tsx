  ...
  return (
    <>
      ...
      <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
        <Layout activo="painel-de-controle" titulo="Painel de Controle">
          <div className="flex flex-col space-y-4">
            ...
            <div className="flex space-x-4">
              <select className="form-select">
                <option value={0}>App Kuenda (Tudo)</option>
              </select>
              <select className="form-select">
                <option value={0}>Personalizado (12/04/2022 - 12/05/2022)</option>
              </select>
            </div>
            <div className="flex space-x-4">
              <KuendaCard
                title="Usuários no Aplicativo"
                className="flex-auto"
                svgIcon={
                    ...
                    <div className="flex flex-col">
                      <div className="flex flex-col space-y-4" style={{ width: 150 }}>
                        <div className="flex flex-col justify-center items-center">
                          <span className="text-black text-8xl">350k</span>
            ...
            <KuendaCard title="" className="h-full">
              <div className="flex justify-center items-center">
                <KuendaCardTotalItem total={650} legend="Total de Visitas no Aplicativo" />
              </div>
            </KuendaCard>
            <div className="flex space-x-5">
              <KuendaCard
                title="Cliques em páginas"
                svgIcon={
              ...
              >
                <KuendaCardTotalItem total={35700000} legend="Total de Ganho em Vendas" />
              </KuendaCard>
              ...
              <KuendaTable header={
                <KuendaTableHeader>
                  <KuendaTableHeaderRow>
                    ...
                    <KuendaTableHeaderRowCell text="Loja" />
                  </KuendaTableHeaderRow>
                </KuendaTableHeader>
              }>
                <KuendaTableRow>
